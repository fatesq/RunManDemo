...
export default class Get extends React.PureComponent {
  ...
  componentDidMount() {
    this.props.dispatch({
      ...
      const { takeCost, nightCost, baseWeight, weightCost, baseDistance, distanceCost } = this.props.config;
      this.setState({ buyCost: takeCost, nightCost, baseWeight, weightCost, baseDistance, distanceCost });
    });
